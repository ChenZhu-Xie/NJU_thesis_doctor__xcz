...
\begin{tabular}{c|c|c|c|c}
	...
	& 无衬线体 $\mathsf{mathsf}$ & 另一个（相关）物理量，或（转置）算符 & $\overline{\Xint{\mathcolor{gray}{-}}{25}{\bar{\mathsfit{v}}}^{\;\! \mathcolor{gray}{\omega} \textcolor{ForestGreen}{\imath}}_{\textcolor{ForestGreen}{(1)} \textcolor{Peach}{\jmath}}}^\mathsf{T}$ 中的 $\mathsfit{v}$ 和 $\mathsf{T}$ & \blabel{hook:mathsf} \\ \midrule
...
\begin{tabular}{c|c|c|c|c}
	...
	& {\color{gray} 灰色 gray} & （附属某因变量的）自变量，或对应的散度分量 or 微分算子 & $\bar{E}^{\;\!\mathcolor{gray}{t}}_{\;\!\mathcolor{gray}{z}}$ 中的 $\mathcolor{gray}{t,z}$ & \blabel{hook:gray} \\ \midrule
	彩色 other & \textcolor{Maroon}{褐红 Maroon} & 起补充说明作用的直体文字 & ${\rho}_{\;\!\textcolor{Maroon}{\text{f}}}, \bar{J}_{\;\!\textcolor{Maroon}{\text{f}}}$ 中的 $\textcolor{Maroon}{\text{f}}$ & \blabel{hook:Maroon} \\
	& \textcolor{ForestGreen}{森林绿 ForestGreen} & （另一种）起补充说明作用的直体文字 or 变量 & $\Xint{\begin{smallmatrix} ~ \\ {}^{}_{\mathcolor{gray}{-}} \\ ~ \end{smallmatrix}}{15}{\bar{v}}^{\;\!\mathcolor{gray}{\omega}}_{\textcolor{ForestGreen}{\jmath}}$ 中的 $\textcolor{ForestGreen}{\jmath}$ & \blabel{hook:ForestGreen} \\
	& \textcolor{Peach}{桃橘 Peach} & （另一种）起补充说明作用的直体文字 or 变量 & $\Xint{\mathcolor{gray}{-}}{25}{\bar{\mathsfit{v}}}^{\;\! \mathcolor{gray}{\omega} \textcolor{ForestGreen}{\imath}}_{\textcolor{ForestGreen}{(1)} \textcolor{Peach}{\jmath}}$ 中的 $\textcolor{Peach}{\jmath}$ & \blabel{hook:Peach} \\ \bottomrule[2pt]
\end{tabular}
}
\end{table}
