...
\begin{tabular}{c|c|c|c|c}
	...
	& 无衬线体 $\mathsf{mathsf}$ & 另一个（相关）物理量，或（转置）算符 & $\overline{\Xint{\mathcolor{gray}{-}}{25}{\bar{\mathsfit{v}}}^{\;\! \mathcolor{gray}{\omega} \textcolor{ForestGreen}{\imath}}_{\textcolor{ForestGreen}{(1)} \textcolor{RedOrange}{\jmath}}}^\mathsf{T}$ 中的 $\mathsfit{v}$ 和 $\mathsf{T}$ & \blabel{hook:mathsf} \\ \midrule
...
\begin{tabular}{c|c|c|c|c}
	...
	& \textcolor{ForestGreen}{森林绿 ForestGreen} & （另一种）起补充说明作用的文字 or 变量（\textcolor{ForestGreen}{进阶·晶体光学}） & $\Xint{\begin{smallmatrix} ~ \\ {}^{}_{\mathcolor{gray}{-}} \\ ~ \end{smallmatrix}}{15}{\bar{v}}^{\;\!\mathcolor{gray}{\omega}}_{\textcolor{ForestGreen}{\jmath}}$ 中的 $\textcolor{ForestGreen}{\jmath}$ & \blabel{hook:ForestGreen} \\
	& \textcolor{RedOrange}{红橘 RedOrange} & （另一种）起补充说明作用的文字 or 变量（\textcolor{RedOrange}{进阶·线性代数}） & $\Xint{\mathcolor{gray}{-}}{25}{\bar{\mathsfit{v}}}^{\;\! \mathcolor{gray}{\omega} \textcolor{ForestGreen}{\imath}}_{\textcolor{ForestGreen}{(1)} \textcolor{RedOrange}{\jmath}}$ 中的 $\textcolor{RedOrange}{\jmath}$ & \blabel{hook:RedOrange} \\ 
	& \textcolor{Cerulean}{蔚蓝 Cerulean} & （另一种）起补充说明作用的直体文字（\textcolor{Cerulean}{进阶·物理术语}） & $\Xint{\mathcolor{gray}{-}}{25}{\bar{\mathsfit{v}}}^{\;\! \mathcolor{gray}{\omega} \textcolor{ForestGreen}{\imath}}_{\textcolor{ForestGreen}{(1)} \textcolor{RedOrange}{\jmath}}$ 中的 $\textcolor{RedOrange}{\jmath}$ & \blabel{hook:Cerulean} \\ \bottomrule[2pt]
\end{tabular}
}
\end{table}
