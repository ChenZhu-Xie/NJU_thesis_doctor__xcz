...
\begin{table}[h!]
	...
	\begin{tabular}{c|c|c|c|c}
		...
		& 无衬线体 $\mathsf{mathsf}$ & 另一个（相关）物理量，或（转置）算符 & $\overline{\Xint{\mathcolor{gray}{-}}{25}{\bar{\mathsfit{v}}}^{\;\! \mathcolor{gray}{\omega} \textcolor{ForestGreen}{\imath}}_{\textcolor{ForestGreen}{(1)} \textcolor{Peach}{\jmath}}}^\mathsf{T}$ 中的 $\mathsfit{v}$ 和 $\mathsf{T}$ & \blabel{hook:mathsf} \\
