...
\begin{table}[h!]
	...
	\begin{tabular}{c|c|c|c|c}
		...
		细分 font & 黑板粗体 $\mathbb{mathbb}$ & 数学常量 $\mathbb{e},\mathbb{i}$、数学集合 $\mathbb{R},\mathbb{C}$、数学微分符号 $\mathbb{d}$ & $\mathbb{e},\mathbb{i};\mathbb{d};\mathbb{R},\mathbb{C}$ & \blabel{hook:mathbb} \\ 
		& 打字机体 $\mathtt{mathtt}$ & 另一个（相关的）物理量，如非相位部分 $\to$ 复振幅 & $\Xint{\begin{smallmatrix} ~ \\ {}^{}_{\mathcolor{gray}{-}} \\ ~ \end{smallmatrix}}{09}{\mathtt{g}}^{\;\!\mathcolor{gray}{\omega} \textcolor{Maroon}{\jmath}}_{\;\! \mathcolor{gray}{z}}$ & \blabel{hook:mathtt} \\ \midrule
%		& 无衬线体 $\mathsfit{mathsfit}$ & 另一个（相关的）物理量，如非相位部分 $\to$ 偏振态 & $\Xint{{}^{}_{\mathcolor{gray}{-}}}{08}{\bar{\mathsfit{g}}}^{\;\!\mathcolor{gray}{\omega} \textcolor{Maroon}{\jmath}}$ & \blabel{hook:mathsfit} \\ \midrule
...
%			& 3 个上实点 $\dot{\ddot{~}}$ & 该转换张量对应的“结果张量”提升 3 阶 & $\dot{\ddot{\chi}}$ & \blabel{hook:dddot} \\ \midrule
		...
		& 3 条上短线 $\bar{\bar{\bar{~}}}$ & \hphantom{列向量 =} 张量：3 阶张量 & $\bar{\bar{\bar{\chi}}}$, $\bar{\bar{\bar{O}}}$ & \blabel{hook:3bar} \\
