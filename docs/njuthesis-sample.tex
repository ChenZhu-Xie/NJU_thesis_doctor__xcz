...
\begin{table}[h!]
	...
	\resizebox{1.0\linewidth}{!}{  % 宽度不超文本宽度
		\begin{tabular}{c|c|ccc}
			...
			颜色 Color & {\color{Maroon} 褐红 Maroon} & 起补充说明作用的文字脚标 &  & test\blabel{Maroon}dd \\
			$a_1$  & 1 & 0.3010 & 0.1695 & 0.1021 \\
			$a_2$  &        & 0.4554 & 0.2984 & 0.2048 \\
			$a_3$  &        &        & 0.3503 & 0.2606 \\
			$a_4$  &        &        &        & 0.2859 \\
			$a_5$  &        &        &        &        \\
			$a_6$  &        &        &        &        \\
			...
			$a_9$  &        &        &        &        \\
			$a_{10}$ &        &        &        &      \\ \midrule[1.2pt]
			$b_1$  & 1.7321 & 1.1486 & 1.0745 & 1.0422 \\
			$b_2$  &        & 2.0964 & 1.4534 & 1.2470 \\
			$b_3$  &        &        & 2.7821 & 1.7670 \\
			$b_5$  &        &        &        &        \\
			$b_6$  &        &        &        &        \\
			$b_7$  &        &        &        &        \\
