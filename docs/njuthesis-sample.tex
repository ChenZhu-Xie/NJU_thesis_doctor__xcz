...
\begin{table}[h!]
	...
	\resizebox{1.0\linewidth}{!}{  % 宽度不超文本宽度
		\begin{tabular}{c|c|c|c|c}
			\toprule[2pt]
			类 Class & 对象 Object & 含义 Meaning & 实例 Instance & 来源 Origin \\ \midrule[1.2pt]
			划线 line & 0 条上短线 \hphantom{$\bar{~}$} & \hphantom{列向量 =} 标量 = 0 阶张量 & ${\rho}_{\;\!\textcolor{Maroon}{\symup{e}}}$ 中的 $\rho$ & \blabel{0bar} \\
			& 1 条上短线 $\bar{~}$ & 列向量 = 矢量 = 1 阶张量 & $\bar{J}_{\;\!\textcolor{Maroon}{\symup{e}}}$ 中的 $\bar{J}$ & \blabel{1bar} \\
			上线 up & 2 条上短线 $\bar{\bar{~}}$ & \hphantom{列向量 =} 张量：2 阶张量 & $\bar{J}_{\;\!\textcolor{Maroon}{\symup{e}}}$ 中的 $\bar{J}$ & \blabel{Maroon} \\
...
\begin{table}[h!]
	...
	\resizebox{1.0\linewidth}{!}{  % 宽度不超文本宽度
		\begin{tabular}{c|c|c|c|c}
			...
			& {\color{Maroon} 褐红 Maroon} & 起补充说明作用的直体文字脚标 & ${\rho}_{\;\!\textcolor{Maroon}{\symup{e}}}, \bar{J}_{\;\!\textcolor{Maroon}{\symup{e}}}$ 中的 $\textcolor{Maroon}{\symup{e}}$ & \blabel{Maroon} \\
			$b_3$  &        &        & 2.7821 & 1.7670 \\
			$b_5$  &        &        &        &        \\
			$b_6$  &        &        &        &        \\
			$b_7$  &        &        &        &        \\
