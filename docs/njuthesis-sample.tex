...
\begin{table}[h!]
	...
	\begin{tabular}{c|c|c|c|c}
		...
		& 打字机体 $\mathtt{mathtt}$ & 另一个（相关的）物理量，如非相位部分 $\to$ 复振幅 & $\Xint{{}^{}_{\mathcolor{gray}{-}}}{02}{\mathtt{g}}^{\;\!\mathcolor{gray}{\omega} \textcolor{Maroon}{\jmath}}_{\;\! \mathcolor{gray}{z}}$ & \blabel{hook:mathtt} \\ 
