...
\textcolor{Maroon}{非线性角谱}的\textbf{出发点}很简单：如果不把\textcolor{Plum}{微-积分方程} \bref{eq:up-scalar-g-EE-312-discrete-convolution4,eq:Born_approx-scalar-g-E-12-convolution4} 沿 $\mathcolor{gray}{z}$ 定积分，那么在不考虑\textcolor{gray}{纵向}\textcolor{NavyBlue}{倒格矢} $\mathcolor{gray}{q_{\symup{z}}}$ 的情况下，要么对 \textcolor{gray}{2 维} $\mathcolor{gray}{\bar{k}_{\symup{\rho}}}$ 阵列中的每一个点，都进行一次\textcolor{gray}{横向}\textcolor{Plum}{高维卷积}积分（\textcolor{gray}{维度} = 2 * \textcolor{NavyBlue}{驱动源}中的\textcolor{NavyBlue}{混频场}数量），要么\textcolor{gray}{纵向}以\textcolor{Plum}{小步长}、\textcolor{Plum}{大步数}，进行\textcolor{Maroon}{分步傅立叶变换}迭代。
